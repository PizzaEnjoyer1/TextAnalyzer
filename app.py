...
with st.expander('Analizar Polaridad y Subjetividad en un texto'):
    ...
    if text1:
        ...
        if x >= 0.3:
            ...
            st.audio(positive_audio_url)  # Reproduce el audio positivo
            ...
            st.audio(negative_audio_url)  # Reproduce el audio negativo
            ...
            st.audio(neutral_audio_url)  # Reproduce el audio neutral
    else:
